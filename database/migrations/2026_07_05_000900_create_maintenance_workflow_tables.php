...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('maintenance_cases', function (Blueprint $table) {
            ...
            $table->string('problem_summary', 500); $table->text('problem_details');
            ...
            $table->text('final_reason')->nullable(); $table->text('collection_instructions')->nullable();
            $table->timestamp('finalized_at')->nullable(); $table->timestamps();
        });
        ...
        Schema::create('maintenance_reports', function (Blueprint $table) {
            ...
            $table->text('findings'); $table->text('work_performed')->nullable();
            ...
            $table->timestamp('submitted_at'); $table->timestamps();
        ...
        Schema::create('maintenance_reviews', function (Blueprint $table) {
            ...
            $table->string('decision', 20)->index(); $table->text('comments');
            $table->timestamp('reviewed_at'); $table->timestamps();
        });
        ...
        Schema::create('spare_requisitions', function (Blueprint $table) {
            ...
            $table->text('procurement_comments')->nullable(); $table->timestamp('decided_at')->nullable();
            $table->text('issued_items')->nullable(); $table->unsignedInteger('issued_quantity')->nullable();
            ...
            $table->text('receipt_remarks')->nullable(); $table->timestamp('received_at')->nullable();
            $table->timestamps();
        });
        ...
        Schema::create('maintenance_return_confirmations', function (Blueprint $table) {
            ...
            $table->string('condition_received', 30); $table->boolean('correct_asset');
            $table->text('comment')->nullable(); $table->timestamp('confirmed_at'); $table->timestamps();
        });
